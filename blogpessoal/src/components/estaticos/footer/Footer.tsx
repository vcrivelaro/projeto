                ...
                <Grid alignItems="center" item xs={12}>
                    <Box style={{ backgroundColor: "#3F51B5", height: "120px" }}>
                        ...
                        <Box display="flex" alignItems="center" justifyContent="center">
                            ...
                            <a href="https://twitter.com/VitsCrivelaro" target="_blank">
                    ...
                    <Box style={{ backgroundColor: "#303F9F", height: "60px" }}>
                        ...
                        <Box>
                            <a target="_blank" href="https://filmejogosanime.herokuapp.com/">
                                <Typography variant="subtitle2" gutterBottom style={{ color: "white" }} align="center">Meu Site</Typography>
                            </a>
                        </Box>
                    </Box>
                </Grid>
